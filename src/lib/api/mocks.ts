// ─────────────────────────────────────────────────────────────────────────────
// Module: Core Mocks (Fixtures & Teams)
// Responsibility: Provide team directory + day-based fixture generator.
// Notes:
// - Stable for home/fixtures screens.
// - Match Page detail mocks live in ./match.mocks.ts (uses mockTeams below).
// ─────────────────────────────────────────────────────────────────────────────

import type { Match, Team } from './types';

const crest = (name: string) =>
  `/api/crest?name=${encodeURIComponent(name)}&size=32`;

// Exported so match.mocks.ts can reuse the same teams (no duplication)
export const mockTeams: Record<string, Team> = {
  ...
  't-2': {
    ...
    league: 'Premier League',
    form: ['L', 'W', 'W', 'D', 'L'],
    stats: { gf: 12, ga: 14, pts: 15 },
  },
  't-3': {
    id: 't-3',
    name: 'Real Madrid',
    crest: crest('Real Madrid'),
    league: 'La Liga',
    form: ['W', 'W', 'W', 'W', 'W'],
    stats: { gf: 22, ga: 5, pts: 30 },
  },
  't-4': {
    id: 't-4',
    name: 'Barcelona',
    crest: crest('Barcelona'),
    league: 'La Liga',
    form: ['D', 'W', 'W', 'L', 'W'],
    stats: { gf: 17, ga: 8, pts: 24 },
  },
  't-5': {
    id: 't-5',
    name: 'Inter',
    ...
    league: 'Serie A',
    form: ['W', 'D', 'W', 'W', 'W'],
    stats: { gf: 20, ga: 7, pts: 28 },
  },
  't-6': {
    id: 't-6',
    name: 'International Sports Club of North London',
    crest: crest('International Sports Club of North London'),
    league: 'UEFA Champions League',
    form: ['W', 'D', 'W', 'D', 'L'],
    stats: { gf: 9, ga: 6, pts: 15 },
  },
};
  ...
  return [
    // 1) UPCOMING — Premier League
    {
      ...
      teams: {
        home: {
          id: 't-1',
          name: mockTeams['t-1'].name,
          crest: mockTeams['t-1'].crest,
        },
        away: {
          id: 't-2',
          name: mockTeams['t-2'].name,
          crest: mockTeams['t-2'].crest,
        },
      },
    ...
    // 3) HT — La Liga
    {
      ...
      teams: {
        home: {
          id: 't-3',
          name: mockTeams['t-3'].name,
          crest: mockTeams['t-3'].crest,
        },
        away: {
          id: 't-2',
          name: mockTeams['t-2'].name,
    ...
    // 4) FT — high score (layout stretch)
    {
      ...
      teams: {
        home: {
          id: 't-6',
          name: mockTeams['t-6'].name,
          crest: mockTeams['t-6'].crest,
        },
        away: {
          id: 't-3',
          name: mockTeams['t-3'].name,
    ...
    // 5) POSTPONED
    {
      ...
      teams: {
        ...
        away: {
          id: 't-4',
          name: mockTeams['t-4'].name,
          crest: mockTeams['t-4'].crest,
        },
      },
      score: { home: 0, away: 0, minute: 0 },
      events: [],
    ...
    // 6) CANCELED
    {
      ...
      teams: {
        home: {
          id: 't-5',
          name: mockTeams['t-5'].name,
          crest: mockTeams['t-5'].crest,
        },
        away: {
          id: 't-2',
          name: mockTeams['t-2'].name,
    ...
    // 8) ET — after extra time
    {
      ...
      score: { home: 2, away: 2, minute: 0 }, // shown as 2—2 (AET)
      events: [
    ...
    // 9) PEN — decided on penalties
    {
      ...
      score: { home: 2, away: 2, minute: 0 }, // e.g., 2—2 (4—3 pens)
      events: [
    ...
    // 13) SUSPENDED
    {
      ...
      score: { home: 1, away: 0, minute: 0 }, // score at suspension time
      events: [],
    },
    ...
    // 14) ABANDONED
    {
      ...
      score: { home: 0, away: 0, minute: 0 }, // typically voided
      events: [],
    },
  ];
}
