...
// -----------------------------------------------------------------------------
//
// NOTE: Includes a synthetic "All leagues" option that has no LEAGUE_META
//       entry. When selected, the /teams page shows all teams and hides the
//       LeagueInfoBanner (leagueMeta will be undefined).
// -----------------------------------------------------------------------------
