// =============================================================================
// COMPONENT: TeamsPageClient
// -----------------------------------------------------------------------------
// Responsibility: Client-side /teams view (header + league banner + teams grid).
...
// A11y: Lives under <main id="main-content"> from RootLayout (no nested <main>);
...
// -- RENDER -------------------------------------------------------------------
export default function TeamsPageClient(): React.ReactElement {
